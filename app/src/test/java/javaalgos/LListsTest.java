...
public class LListsTest {
    ...
    @Test
    public void testReverseSublistLinkedList() {
    ...
    @Test
    public void testDeleteKthLastElementFromLinkedList() {
    ...
    @Test
    public void testRemoveDuplicateValuesFromLinkedList() {
        LLists.ListNode a = new LLists.ListNode(2);
    ...
    @Test
    public void testCyclicShiftLinkedList() {
    ...
    @Test
    public void testIsLinkedListPalindromic() {
        LLists.ListNode a = new LLists.ListNode(1);
        LLists.ListNode b = new LLists.ListNode(2);
        LLists.ListNode c = new LLists.ListNode(3);
    ...
    @Test
    public void testLinkedListPivoting() {
    ...
    @Test
    public void testAddTwoNumbersRepresentedAsLinkedLists() {
        LLists.ListNode a = new LLists.ListNode(3);
        LLists.ListNode b = new LLists.ListNode(2);
        LLists.ListNode c = new LLists.ListNode(3);
        LLists.ListNode d = new LLists.ListNode(1);
