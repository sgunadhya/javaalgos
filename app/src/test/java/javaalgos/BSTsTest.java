...
public class BSTsTest {
    ...
    @Test
    public void testGetLCAofTwoNodes() {
        assertTrue(BSTs.findLCA(a, c, f) == b);
    }

    @Test
    public void testReconstructBSTFromTraversal() {

    }

    @Test
    public void testClosestEntriesInSortedArrays() {
    ...
    @Test
    public void testMostVisitedPages() {

    }

    @Test
    public void testMinimumHeightBSTFromASortedArray() {
        BSTs.BSTNode r = BSTs.buildMinHeightBST(new int[]{2, 3, 5, 7, 11, 13, 17, 19, 23});
        assertTrue(r.data == 11);
    }

    @Test
    public void testIfThreeBSTNodesAreTotallyOrdered() {
