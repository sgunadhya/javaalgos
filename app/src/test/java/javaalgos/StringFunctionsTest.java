...
public class StringFunctionsTest {
    ...
    @Test
    public void testLongestPalindromicSubstringEmpty() {
        String p = StringFunctions.longestPalindromicSubString("");
        assertEquals("", p);
    }

    @Test
    public void testLongestPalindromicSubstringNonEmpty() {
        String p = StringFunctions.longestPalindromicSubString("tabam");
        assertEquals("aba", p);
    }

    @Test
    public void testMaxBorderLen() {
    ...
    @Test
    public void testMaxBorderLenTrue() {
